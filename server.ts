...
var __copyProps = (到, ffrom, except, desc) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames(from))
      if (!__hasOwnProp.call(到, key) && key !== except)
        __defProp(t到, key, { get: () => from[key], enumerable: !(desc = __getOwnPropDesc(from, key)) || desc.enumerable });
  }
  return to;
};
var __toESM = (mod, isNodeMode, target\""""\"=> ("target = mod != null ? __create(__getProtoOf(模组"")"\") : {}, __copyProps(
