...
highp float ColorEffectShader_QM13_3_Circle(highp vec2 fragCoordinate,
...
highp float ColorEffectShader_QM13_3_circleDepth_1(highp vec2 fragCoordinate,
                                                   highp float progressTime)
{
    highp vec2 circleCoordinate = vec2(0.4 * progressTime, 1.0);
    highp float circleRadius = 0.5 - 0.2 * progressTime;
    highp float circleAlpha = 0.4;
    highp float circleDepth = ColorEffectShader_QM13_3_Circle(fragCoordinate, circleCoordinate, circleRadius, circleAlpha);
    return circleDepth;
}

highp float ColorEffectShader_QM13_3_circleDepth_2(highp vec2 fragCoordinate,
                                                   highp float progressTime)
{
    highp vec2 circleCoordinate = vec2(1.0 - 0.3 * progressTime, 0.0);
    highp float circleRadius = 0.25 + 0.25 * progressTime;
    highp float circleAlpha = 0.4;
    highp float circleDepth = ColorEffectShader_QM13_3_Circle(fragCoordinate, circleCoordinate, circleRadius, circleAlpha);
    return circleDepth;
}
...
void main()
{
    ...
    highp float circleDepth_1 = ColorEffectShader_QM13_3_circleDepth_1(fragCoordinate, progressTime);
    highp float circleDepth_2 = ColorEffectShader_QM13_3_circleDepth_2(fragCoordinate, progressTime);
    highp vec4 circleColor_1 = vec4(firstColor, 1.0);
    highp vec4 circleColor_2 = vec4(firstColor, 1.0);
