...
public final class PlayerDiscAlbumPoleView extends FrameLayout {
    ...
    public static final class ReverseDetectableAnimator {
        ...
        public int hashCode() {
            ...
            return (this.f34593a.hashCode() * 31) + Boolean.hashCode(this.b);
        }
    ...
    public PlayerDiscAlbumPoleView(@NotNull Context context) {
        ...
        AppCompatImageView asyncImageView = new AppCompatImageView(getContext());
    ...
    */
        ...
        if (bArr == null || ((bArr[1366] >> 4) & 1) <= 0 || !SwordProxy.proxyOneArg(Boolean.valueOf(z), this, 22133).isSupported) {
            if (getContext() instanceof Activity) {
                ...
                if (activity.isFinishing() || activity.isDestroyed()) {
                    Log.i("PlayerDiscAlbumPoleView", "startNewPoleSwitchAnimator return activity is finish");
                    return;
                }
            }
            ...
            objectAnimatorOfFloat.setInterpolator(new CubicBezierInterpolator(0.4d, 0.0d, 0.45d, 1.0d));
            objectAnimatorOfFloat.addListener(new Animator.AnimatorListener() { // from class: com.tencent.qqmusic.ui.PlayerDiscAlbumPoleView$startNewPoleSwitchAnimator$1$1
                ...
                public void onAnimationEnd(Animator animation, boolean z2) {
                    ...
                    if (bArr2 == null || ((bArr2[1155] >> 1) & 1) <= 0 || !SwordProxy.proxyMoreArgs(new Object[]{animation, Boolean.valueOf(z2)}, this, 20442).isSupported) {
                        ...
                        PlayerDiscAlbumPoleView playerDiscAlbumPoleView = PlayerDiscAlbumPoleView.this;
                        boolean z4 = z;
                        playerDiscAlbumPoleView.l = (z4 && !z2) || (!z4 && z2);
                        if (PlayerDiscAlbumPoleView.this.l != PlayerDiscAlbumPoleView.this.m) {
                            PlayerDiscAlbumPoleView playerDiscAlbumPoleView2 = PlayerDiscAlbumPoleView.this;
                            playerDiscAlbumPoleView2.j(playerDiscAlbumPoleView2.m);
                            return;
                        }
                        if (PlayerDiscAlbumPoleView.this.l) {
                            PlayerDiscAlbumPoleView.this.o();
                            if (PlayerDiscAlbumPoleView.this.getWindowVisibility() != View.VISIBLE) {
                                ObjectAnimator objectAnimator = PlayerDiscAlbumPoleView.this.d;
                            ...
                            ObjectAnimator objectAnimator2 = PlayerDiscAlbumPoleView.this.d;
                            if (objectAnimator2 != null && objectAnimator2.isPaused()) {
                                z3 = true;
                            }
                            if (z3) {
                                ObjectAnimator objectAnimator3 = PlayerDiscAlbumPoleView.this.d;
                            ...
                            ObjectAnimator objectAnimator4 = PlayerDiscAlbumPoleView.this.d;
                ...
                public void onAnimationStart(Animator animation) {
                    ...
                    if (bArr2 == null || ((bArr2[1153] >> 2) & 1) <= 0 || !SwordProxy.proxyOneArg(animation, this, 20427).isSupported) {
                        Intrinsics.checkNotNullParameter(animation, "animation");
                        PlayerDiscAlbumPoleView.this.l = false;
                        ObjectAnimator objectAnimator = PlayerDiscAlbumPoleView.this.d;
                        if (objectAnimator != null) {
    ...
    @NotNull
    public final AppCompatImageView getPoleImageView() {
        return this.b;
    }
    ...
    public final void setAnglePole(float f, float f2) {
        ...
        if (bArr == null || ((bArr[1358] >> 4) & 1) <= 0 || !SwordProxy.proxyMoreArgs(new Object[]{Float.valueOf(f), Float.valueOf(f2)}, this, 22069).isSupported) {
            ...
            Log.w("PlayerDiscAlbumPoleView", "setAnglePole error " + f + "," + f2);
        }
    }
