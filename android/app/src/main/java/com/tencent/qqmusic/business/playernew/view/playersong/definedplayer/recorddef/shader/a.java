...
public final class a extends TekBaseShader {
    ...
    public Map<String, Object> getParamMap() {
        ...
        this.d += 0.03333333f;
        linkedHashMap.put("IsForSurfaceView", Integer.valueOf(this.mIsForSurfaceView));
        linkedHashMap.put("BgColor", TekBaseShader.toBgColorFloats(this.mBgColor));
        linkedHashMap.put("AspectRatio", Float.valueOf(this.aspectRatio));
