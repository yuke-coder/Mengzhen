...
public final class PlayModePopupWindowItem {
    ...
    public PlayModePopupWindowItem(@NotNull Context context, @NotNull ItemType itemType, @NotNull c cVar) throws NoWhenBranchMatchedException {
        ...
        if (i == 1) {
            viewInflate.setContentDescription(context.getString(R.string.qq_mode_shuffle));
            imageView.setImageResource(R.drawable.popup_window_play_mode_shuffle);
            textView2.setText(R.string.qq_mode_shuffle);
        } else if (i == 2) {
            viewInflate.setContentDescription(context.getString(R.string.qq_mode_list_repeat));
            imageView.setImageResource(R.drawable.popup_window_play_mode_list_repeat);
            textView2.setText(R.string.qq_mode_list_repeat);
        } else if (i == 3) {
            viewInflate.setContentDescription(context.getString(R.string.qq_mode_single_repeat));
            imageView.setImageResource(R.drawable.popup_window_play_mode_onshot_repeat);
            textView2.setText(R.string.qq_mode_single_repeat);
        } else if (i == 4) {
